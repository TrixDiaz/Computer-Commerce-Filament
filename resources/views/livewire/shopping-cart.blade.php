...
}" wire:poll.5s="[getUpdatedCart,loadUserAddresses,fetchRelatedProducts]">
                                    ...
                                    <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                        ...
                                        <div class="flex items-center justify-between md:order-3 md:justify-end">
                                            <div class="flex items-center">
                                                <button type="button" @click="$wire.updateQuantity(productId, item.quantity - 1)" class="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700" :disabled="item.quantity <= 1">
                                                ...
                                                <button type="button" @click="$wire.updateQuantity(productId, item.quantity + 1)" class="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700" :disabled="item.quantity >= item.stock">
                                            ...
                                            <div class="text-end md:order-4 md:w-32">
                                                ...
                                                <p class="text-sm text-gray-500 dark:text-gray-400" x-text="'Stock: ' + item.stock"></p>
                                            </div>
                                        </div>
