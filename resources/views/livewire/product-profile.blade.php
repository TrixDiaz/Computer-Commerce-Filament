    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
            ...
            <div class="flex space-x-4">
                ...
                <button wire:click="payWithGCash({{ $product->id }})" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    Pay with GCash
                </button>
            </div>

            @guest
                <p class="mt-4 text-red-500">Please <a href="{{ route('login') }}" class="underline">login</a> to add items to your cart.</p>
            @endguest
        </div>
    </div>
</div>