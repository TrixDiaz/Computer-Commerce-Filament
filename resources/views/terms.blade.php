<x-guest-layout>
    <div class="bg-gray-100 max-w-7xl mx-auto p-4">
        <h1 class="text-3xl font-bold mb-4">Terms and Conditions</h1>

            <p class="mb-4">
                This terms and conditions sets out how our website uses and protects any information that you give us when you
                use
                this
                website.
            </p>
