            ...
            <tbody>
                @foreach($orders as $order)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-300">
                            <button wire:click="viewOrderDetails({{ $order->id }})" class="text-indigo-600 hover:text-indigo-900 mr-2">View Details</button>
                            <button wire:click="generateInvoice({{ $order->id }})" class="text-green-600 hover:text-green-900">Generate Invoice</button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
